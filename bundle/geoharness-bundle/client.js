  ...
  factory: (externalRequire) => {
    const __localFactories = {
      ...
      './layer-registry': (module, exports, require) => {
        ...
        exports.setLayerStyle = setLayerStyle;
        exports.resetLayerStyle = resetLayerStyle;
        const STYLE_BY_NAME = {
        ...
        function setLayerStyle(layers, layerId, style) {
        ...
        function resetLayerStyle(layers, layerId) {
      ...
      './ui-model': (module, exports, require) => {
         ...
         * declare.
         */
        function buildFeatureFlow(inputLayers, outputLayers, limit = 8) {
        ...
        function collectNumbers(value, path, target, depth) {
            if (target.length >= 12 || depth > 5)
                return;
        ...
        function buildNumericStatistics(value) {
            const rows = [];
        ...
        function groupWorkspaceLayers(layers) {
        ...
        function parseCsvPreview(text) {
            ...
            if (delimiter === undefined || delimiter.count === 0)
                return null;
        ...
        function suggestCoordinateField(fields, axis) {
    ...
    function renderLayerRow(sessionId, layer, highlightedLayerIds, selectedLayerId, onInspect, onPreference, outputStatus) {
        ...
        return ((0, jsx_runtime_1.jsxs)("article", { className: `gh-layer-row${highlightedLayerIds.has(layer.id) ? ' is-step-highlighted' : ''}${selectedLayerId === layer.id ? ' is-data-selected' : ''}`, "data-layer-id": layer.id, "data-layer-name": layer.name, children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: layer.visible ? 'gh-layer-toggle is-visible' : 'gh-layer-toggle', "aria-label": `${layer.visible ? 'Hide' : 'Show'} ${layer.name}`, "aria-pressed": layer.visible, onClick: () => {
                        ...
                        onPreference(layer.id, { visible: !layer.visible });
                            ...
                            }, onMouseUp: event => persistOpacity(event.currentTarget), onTouchEnd: event => persistOpacity(event.currentTarget), onKeyUp: event => persistOpacity(event.currentTarget), onBlur: event => persistOpacity(event.currentTarget) }), (0, jsx_runtime_1.jsxs)("details", { className: "gh-layer-style-controls", children: [(0, jsx_runtime_1.jsx)("summary", { children: "\u6837\u5F0F" }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("label", { title: "\u56FE\u5C42\u989C\u8272", children: [(0, jsx_runtime_1.jsx)("span", { children: "\u989C\u8272" }), (0, jsx_runtime_1.jsx)("input", { type: "color", value: layer.style.color, "aria-label": `${layer.name} color`, onChange: event => {
                                                        const color = event.currentTarget.value;
                                                        layerWorkspace.update(sessionId, current => (0, layer_registry_1.setLayerStyle)(current, layer.id, { color }));
                                                    } })] }), (0, jsx_runtime_1.jsxs)("label", { title: "\u8FB9\u7EBF\u5BBD\u5EA6", children: [(0, jsx_runtime_1.jsxs)("span", { children: ["\u7EBF\u5BBD ", layer.style.lineWidth.toFixed(1)] }), (0, jsx_runtime_1.jsx)("input", { type: "range", min: "0.5", max: "6", step: "0.5", value: layer.style.lineWidth, "aria-label": `${layer.name} line width`, onChange: event => {
                                                        const lineWidth = Number(event.currentTarget.value);
                                                        layerWorkspace.update(sessionId, current => (0, layer_registry_1.setLayerStyle)(current, layer.id, { lineWidth }));
                                                    } })] }), (0, jsx_runtime_1.jsx)("button", { type: "button", title: "\u6062\u590D GeoHarness \u8BED\u4E49\u6837\u5F0F", onClick: () => {
    ...
    function GeoHarnessDataWorkbench({ layer, details, loading, error, selectedFeatureIndex, onClose, onSelectRow, onReload, onRename, onRemove, }) {
        ...
        const visibleRows = React.useMemo(() => {
            ...
            const filtered = normalized === '' ? details.rows : details.rows.filter(row => details.fields.some(field => (attributeValue(row[field.name]).toLocaleLowerCase().includes(normalized))));
            if (sortField === null)
                return filtered;
    ...
    function ResultCenterPanel({ result, downloading, error, onDownload, onLayer, onLayerFocus, focusedLayerId, }) {
        if (result === null)
        ...
        const featureFlow = (0, ui_model_1.buildFeatureFlow)(result.input_layers, result.output_layers);
        return (0, jsx_runtime_1.jsxs)("section", { className: `gh-agent-block gh-result-center is-${result.status}`, "aria-label": "Result Center", children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsxs)("span", { className: "gh-eyebrow", children: ["RESULT CENTER \u00B7 TURN ", result.turn] }), (0, jsx_runtime_1.jsxs)("small", { children: [result.provider ?? 'provider', " / ", result.model ?? 'model'] })] }), (0, jsx_runtime_1.jsx)("b", { children: result.status })] }), result.final_answer !== null && (0, jsx_runtime_1.jsx)("p", { className: "gh-result-answer", children: result.final_answer }), (0, jsx_runtime_1.jsxs)("div", { className: "gh-result-metrics", children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "Tools" }), (0, jsx_runtime_1.jsxs)("b", { children: [result.tools.success, "/", result.tools.total] })] }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "Inputs" }), (0, jsx_runtime_1.jsx)("b", { children: result.input_layers.length })] }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "Outputs" }), (0, jsx_runtime_1.jsx)("b", { children: result.output_layers.length })] }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "Assets" }), (0, jsx_runtime_1.jsx)("b", { children: result.assets.length })] })] }), featureFlow.items.length > 1 && (0, jsx_runtime_1.jsxs)("div", { className: "gh-result-flow", "aria-label": "Layer feature-count flow", children: [(0, jsx_runtime_1.jsx)("span", { className: "gh-result-section-label", children: "Registered layer feature flow" }), featureFlow.omitted > 0 && (0, jsx_runtime_1.jsxs)("small", { children: ["\u4E3A\u4FDD\u6301\u53EF\u8BFB\u6027\u7701\u7565 ", featureFlow.omitted, " \u4E2A\u8F83\u65E9\u7684\u4E2D\u95F4\u56FE\u5C42"] }), (0, jsx_runtime_1.jsx)("div", { children: featureFlow.items.map(item => (0, jsx_runtime_1.jsxs)("button", { type: "button", className: focusedLayerId === item.layer_id ? 'is-focused' : '', onFocus: () => onLayerFocus(item.layer_id), onMouseEnter: () => onLayerFocus(item.layer_id), onMouseLeave: () => onLayerFocus(null), onClick: () => onLayer(item.layer_id), children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("b", { children: item.name }), (0, jsx_runtime_1.jsx)("small", { children: item.role }), (0, jsx_runtime_1.jsx)("em", { children: item.feature_count.toLocaleString() })] }), (0, jsx_runtime_1.jsx)("i", { children: (0, jsx_runtime_1.jsx)("span", { style: { width: `${item.width}%` } }) })] }, `${item.role}:${item.layer_id}`)) })] }), (result.input_layers.length > 0 || result.output_layers.length > 0) && (0, jsx_runtime_1.jsx)("div", { className: "gh-result-layers", children: [...result.input_layers, ...result.output_layers].map(layer => (0, jsx_runtime_1.jsxs)("button", { type: "button", className: focusedLayerId === layer.layer_id ? 'is-focused' : '', onFocus: () => onLayerFocus(layer.layer_id), onMouseEnter: () => onLayerFocus(layer.layer_id), onMouseLeave: () => onLayerFocus(null), onClick: () => onLayer(layer.layer_id), children: [(0, jsx_runtime_1.jsx)("i", { children: layer.role === 'output' ? '↗' : '→' }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("b", { children: layer.name }), (0, jsx_runtime_1.jsxs)("small", { children: [layer.role, " \u00B7 ", layer.feature_count, " features \u00B7 ", layer.crs] })] })] }, `${layer.role}:${layer.layer_id}`)) }), result.statistics.length > 0 && (0, jsx_runtime_1.jsxs)("div", { className: "gh-result-statistics", children: [(0, jsx_runtime_1.jsx)("span", { className: "gh-result-section-label", children: "Verified Tool statistics" }), result.statistics.map(statistic => {
                            const chartRows = (0, ui_model_1.buildNumericStatistics)(statistic.data);
                            return (0, jsx_runtime_1.jsxs)("details", { open: result.statistics.length === 1, children: [(0, jsx_runtime_1.jsxs)("summary", { children: [statistic.tool, " \u00B7 ", statistic.summary ?? 'structured result'] }), chartRows.length > 1 && (0, jsx_runtime_1.jsx)("div", { className: "gh-stat-chart", "aria-label": `${statistic.tool} numeric statistics`, children: chartRows.map(row => (0, jsx_runtime_1.jsxs)("span", { title: `${row.path}: ${row.value}`, children: [(0, jsx_runtime_1.jsx)("small", { children: row.path }), (0, jsx_runtime_1.jsx)("i", { children: (0, jsx_runtime_1.jsx)("span", { style: { width: `${row.width}%` } }) }), (0, jsx_runtime_1.jsx)("b", { children: Number(row.value.toPrecision(6)).toLocaleString() })] }, row.path)) }), (0, jsx_runtime_1.jsx)("dl", { children: flattenResultData(statistic.data).map(([key, value]) => (0, jsx_runtime_1.jsxs)(React.Fragment, { children: [(0, jsx_runtime_1.jsx)("dt", { children: key }), (0, jsx_runtime_1.jsx)("dd", { title: value, children: value })] }, key)) })] }, statistic.call_id);
                        })] }), (0, jsx_runtime_1.jsxs)("div", { className: "gh-result-provenance", children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "CRS" }), (0, jsx_runtime_1.jsx)("b", { children: result.crs.join(' · ') || '—' })] }), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("small", { children: "Units" }), (0, jsx_runtime_1.jsx)("b", { children: result.units.join(' · ') || '—' })] }), result.sources.map(source => (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsxs)("small", { children: [source.kind, " \u00B7 ", source.name] }), (0, jsx_runtime_1.jsx)("b", { children: source.detail })] }, source.layer_id))] }), result.warnings.length > 0 && (0, jsx_runtime_1.jsx)("div", { className: "gh-result-warnings", children: result.warnings.map(warning => (0, jsx_runtime_1.jsxs)("small", { children: ["\u26A0 ", warning] }, warning)) }), (0, jsx_runtime_1.jsxs)("div", { className: "gh-result-assets", children: [(0, jsx_runtime_1.jsx)("span", { className: "gh-result-section-label", children: "Downloads" }), result.assets.map(asset => (0, jsx_runtime_1.jsxs)("button", { type: "button", disabled: !asset.downloadable || downloading === asset.asset_id, onClick: () => onDownload(asset), children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("b", { children: asset.file_name }), (0, jsx_runtime_1.jsxs)("small", { children: [asset.format.toUpperCase(), " \u00B7 ", fileSizeLabel(asset.size_bytes), asset.feature_count === null ? '' : ` · ${asset.feature_count} features`] })] }), (0, jsx_runtime_1.jsx)("i", { children: !asset.downloadable ? 'limit' : downloading === asset.asset_id ? '…' : '↓' })] }, `${asset.asset_type}:${asset.asset_id}`))] }), error !== null && (0, jsx_runtime_1.jsx)("p", { className: "gh-result-download-error", role: "alert", children: error })] });
    }
    ...
    function GeoHarnessShell({ agent, sessionId }) {
        ...
        const lastWorkspaceSession = React.useRef(null);
        ...
        const highlightedLayerIds = new Set(layers
            ...
            .map(layer => layer.id));
        if (focusedLayerId !== null && layers.some(layer => layer.id === focusedLayerId))
            highlightedLayerIds.add(focusedLayerId);
        ...
        const focusLayer = (layerId, inspect) => {
        ...
        const selectImportFile = async (file) => {
            ...
            if (extension === '.csv') {
                try {
                    preview = (0, ui_model_1.parseCsvPreview)(await file.slice(0, 128 * 1024).text());
                }
                catch {
            ...
            setImportDraft({
                ...
                sourceLayer: '',
                longitudeField: extension === '.csv' ? (0, ui_model_1.suggestCoordinateField)(preview?.fields ?? [], 'longitude') || 'longitude' : '',
                latitudeField: extension === '.csv' ? (0, ui_model_1.suggestCoordinateField)(preview?.fields ?? [], 'latitude') || 'latitude' : '',
